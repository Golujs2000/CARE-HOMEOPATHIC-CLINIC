      ...
      <div className="container-max section-padding relative z-10 w-full !pt-20 pb-28">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="order-1">
            ...
            >
              Healing Families <span className="text-primary-600">Since 2001</span>
            </motion.h1>
            ...
            >
              ...
              Serving Saharsa since 2001 — 25 Years of Trusted Homeopathic Care
            </motion.div>
            ...
            >
              For 25 years, Dr. Rajesh Kumar Ranjan has delivered authentic, side-effect-free homeopathic treatment at Panchwati Chowk, Saharsa. Expert care for <strong className="text-navy-800">220+ conditions</strong>{' '}
              <Link to="/services" className="text-primary-600 hover:underline font-bold text-sm ml-1">
                (View All)
              </Link>.
            </motion.p>
